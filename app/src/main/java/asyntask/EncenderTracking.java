 ...
 */
public class EncenderTracking  extends AsyncTask<String , Void, String> {
    private Context context;
    private static String SOAP_ACTION1 = "http://tempuri.org/encenderTracking";
    private static String NAMESPACE = "http://tempuri.org/";
    private static String METHOD_NAME1 = "encenderTracking";
    ...
    public EncenderTracking(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            if(result.hasProperty("encenderTrackingResult") && !result.getProperty("encenderTrackingResult").toString().equals("anyType{}")){
                xml = result.getProperty("encenderTrackingResult").toString();
            }else{
                xml = "Proceso Exitoso";
            }
